...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <div>
      ...
      <button id="details-btn" onclick="getDetails(${id})" class="btn  btn-warning">Details</button>
      </div>
      `;
...
const detail = (ditail) => {
  ...
  <div class=" d-lg-flex  justify-content-lg-between justify-content-lg-none align-items-center border p-5 mb-5 border-1 border-danger">
  <div>
